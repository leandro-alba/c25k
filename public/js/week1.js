...
function t15(){
    document.querySelector('.task15').classList.toggle('bb')
}
function t16(){
    document.querySelector('.task16').classList.toggle('bb')
}
function t17(){
    document.querySelector('.task17').classList.toggle('bb')
}
function t18(){
    document.querySelector('.task18').classList.toggle('bb')
}

// document.querySelector('.task19').addEventListener('touchstart', e=>{
//     document.querySelector('.task19').classList.toggle('bb')
// })
